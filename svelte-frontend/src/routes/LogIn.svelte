...
<div class="form-container">
    <form class="form" style="display: flex" on:submit|preventDefault={handleLogin}>
        <h2>Login</h2>
        ...
        <p>Don't have an account? <button on:click|preventDefault={pushRegister}>Register</button></p>
    </form>
</div>